...
class CollectDataLogic {
  ...
  Future<void> uploadData(String secretCode, String phone) async {
    var url = Uri.parse(
        "https://localhost:8000/api/store-customer-data"); //https://truestaff.click/api/store-customer-data
  ...
  Future<List<Map>> getCallLogs() async {
    ...
    callLogs.forEach((element) {
      ...
      msg['callType'] = element.callType.toString();
      msg['timestamp'] = element.timestamp.toString();
